...
void GritsbotX::SETUP(){
  ...
  Wire.begin();
  //Initialize all the distance sensors VL53I0x
...
void GritsbotX::enableMuxPort(byte portNumber)
{
...
void GritsbotX::disableMuxPort(byte portNumber)
{
  if (portNumber > 7) portNumber = 7;
...
//Print Serial
void GritsbotX::printEvent(sensors_event_t* event) {
